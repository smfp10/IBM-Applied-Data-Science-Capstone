...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        site_data = filtered_df.loc[filtered_df['Launch Site'] == entered_site].groupby(['class']).count().reset_index().iloc[:, [0, 1]]
...
def get_scatter_chart(entered_site, entered_payload):
    ...
    if entered_site == 'ALL':
        ...
        site_data = filtered_df.loc[filtered_df['Launch Site'] == entered_site]
        fig = px.scatter(
            site_data,
            y='class',
            x='Payload Mass (kg)',
